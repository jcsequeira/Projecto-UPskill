        ...
        if (eventos.isEmpty()){
            ...
            listView.setOnMouseClicked(event -> {
                ...
                if (selectedShowName != null) {
                    ...
                    // TODO:  delegar esta tarefa para o Presenter -> doShowDetails(Evento event);
                    ExplorArtPresenter presenter = new ExplorArtPresenter(this, new ExplorArtModel());
                    presenter.doShowDetails(selectedShow.get());
